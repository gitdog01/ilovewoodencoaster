...
GENERATIONS = {
    ...
    # gen11/gen12 를 8 인스턴스씩 동시에 돌린 A/B 의 25도 쪽 (run11b), 그리고
    # CPU 경합 확인용 단독 실행 (solo10). 설정은 각각 gen11/gen10 과 같다.
    "run11b_": ("gen11", "", "gen11 (60도 A/B 대조군)"),
    "solo10_": ("gen10", "", "gen10 단독 실행"),
